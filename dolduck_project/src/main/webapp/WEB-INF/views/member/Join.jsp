					...
					<table class="join_form">
						...
						<tr>
							<td><input class="form-control" type="text" class="text"
								name="user_name" placeholder="이름" required /></td>
						</tr>
						<tr>
						</tr>
						<tr>
						...
						<tr>
							<td>
								<div id="id_confirm">
									<input class="form-control" type="text" class="text"
										name="user_id" placeholder="아이디" required /> <input
										type="button" class="idChk" id="btn_idcheck" value="중복확인"
										onclick="id_check()" />
								</div>
								<p class="result">
						...
						<tr>
							<td><input class="form-control" type="text" class="text"
								name="user_phone" placeholder="전화번호" required /></td>
						</tr>
						<tr>
							<th>이메일</th>
						</tr>
						<tr>
							<td><input class="form-control" type="email" class="text"
								name="user_email" placeholder="이메일" required /> <input
								type="button" id="btn_sendemail" value="인증번호발송"
								onclick="sendEmail()" />
								<p></p></td>
						</tr>
						<tr>
						...
						<tr>
							<td><input class="form-control" type="text" name="user_addr"
								id="addr" placeholder="주소" readonly="readonly"> <input
								type="button" id="set_addr" class="e1" onclick="setAddr()"
								value="주소입력"> <input class="form-control" type="text"
...
(시행일) 이 약관은 2014년 5월 1일부터 시행합니다.
						...
						<tr>
							<td align="center" valign="top"><textarea style="width: 98%"
									rows=10 readonly class=ed>&#039;One Green Korea Movement&#039;은 (이하 &#039;단체&#039;는)
...
신용정보의 수집/처리 및 이용 등에 관한 기록 : 3년 (신용정보의 이용 및 보호에 관한 법률)
						...
						<tr>
							<td><div class="g-recaptcha"
									data-sitekey="6LfHerAUAAAAAMuHHv4SxdSPsJgE5L8_PQliNINI"></div></td>
						</tr>

						<tr>
							<td colspan="2"><input id="joinup" type="submit"
								value="회원가입" /></td>
						</tr>
					</table>
