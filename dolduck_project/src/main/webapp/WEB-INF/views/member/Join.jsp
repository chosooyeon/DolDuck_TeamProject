              ...
              <input type="hidden" name="${_csrf.parameterName}" value="${_csrf.token }">			
					...
					<table>
						<tr>
							<th>이름</th>
							<td>
								<input type="text" class="text" name="user_name" placeholder="이름" required />
							</td>
						</tr>
						<tr>
							<th>아이디</th>
						...
						<tr>
							<th>전화번호</th>
							<td>
								<input type="text" class="text" name="user_phone" placeholder="전화번호" required />
							</td>
						</tr>
						<tr>
							<th>주소</th>
							<td>
								<input type="text" class="text" name="user_addr" placeholder="주소" required />
							</td>
						</tr>
						<tr>
							<th>이메일</th>
