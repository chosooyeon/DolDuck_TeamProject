...
<<<<<<< HEAD
			...
			<table class="table_comment">
				<c:forEach items="${commList }" var="comm">
					<tr>
						...
						<td>댓글작성자 : ${comm.freeboard_id }</td>
						<td>댓글작성시간 : ${comm.freeboard_comment_regdate }</td>
			...
			<form action="freeboard_comment_insert.do" method="post">
				...
				<table class="comment_tadle">
					<tr>
						<td id="comment_textarea"><textarea id="comment_textarea_css" rows="2" cols="50" name="freeboard_comment_content"></textarea>
						</td>
...
>>>>>>> f21ef523314acb3857982608e583f8b945f35a8f
	</div>
