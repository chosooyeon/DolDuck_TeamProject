...
<div class="container modified">
	<div class="row">
		<div class="col-lg-6 offset-lg-3 modified_table">
			...
			<form method="post" action="modifiedfied.do">		
					<table class="modified_form">
						<tr>
							<th>이름</th>
						</tr>
						<tr>
								<td><div id="member_name"><c:out value="${dto.member_name }"></c:out></div></td>
						</tr>
						<tr>
						</tr>
						<tr>
						...
						<tr>
								<td><div id="member_id"><c:out value="${dto.member_id }"></c:out></div></td>
						</tr>
						<tr>
						</tr>
						<tr>
						...
						<tr>
							<td>
								<input class="form-control" type="text" class="text" name="user_phone" placeholder="전화번호" value=${dto.member_phone } required="required" />
							</td>
						</tr>
						<tr>
							<th>이메일</th>
						...
						<tr>
							<td>
								<input class="form-control" type="email" class="text" name="user_email" placeholder="이메일" value=${dto.member_email } required="required"/>
						...
						<tr>
							<td>
								<input class="form-control" type="text" name="user_addr" id="addr" placeholder="주소" value="${dto.member_addr }" readonly="readonly"> 
